...
vim.keymap.set("i", "<C-s>", "<Esc>:w<CR>") -- save on insert mode


local hidden_bottom_bar = false

local function hide_bar()
  hidden_bottom_bar = not hidden_bottom_bar

  if hidden_bottom_bar then
...
vim.keymap.set('n', '<leader>bh', hide_bar, { silent = true, desc = "Toggle bottom bars" })
